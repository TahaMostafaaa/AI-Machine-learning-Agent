...
MODEL_NAME = 'pygta5-FPV-color-{}-{}-LR-{}-files-balanced-v13.model'.format('googlenet_color',LR,FILE_I_END)
PREV_MODEL = 'pygta5-FPV-color-{}-{}-LR-{}-files-balanced-v12.model'.format('googlenet_color',LR,FILE_I_END)
